...
class MyApp extends StatelessWidget {
  // Replace this with an actual unique identifier, for testing "user1234" is used.
...
class _SpotifyAuthWidgetState extends State<SpotifyAuthWidget> {
  ...
  Future<void> _attemptToGetUserProfile() async {
    ...
    try {
      _spotifyUserData = await SpotifyUserData.createSpotifyProfile(MyApp.uuid);
