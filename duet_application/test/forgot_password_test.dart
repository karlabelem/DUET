...
void main() {
  testWidgets('forgot password clicking on buttons',
    ...
    final sendCodeFinder = find.ancestor(
    ...
    final verifyButtonFinder = find.ancestor(
        of: find.text('Verify'), matching: find.byType(ElevatedButton));
    expect(verifyButtonFinder, findsOneWidget,
        reason: 'Verify button should be visible');
    ...
    final resetPasswordButtonFinder = find.ancestor(
        of: find.text('Reset password'), matching: find.byType(ElevatedButton));
    expect(resetPasswordButtonFinder, findsOneWidget,
    ...
    final backToLoginButtonFinder = find.ancestor(
        of: find.text('Back to log in'), matching: find.byType(ElevatedButton));
    expect(backToLoginButtonFinder, findsOneWidget,
        reason: 'Back to log in button should be visible');
